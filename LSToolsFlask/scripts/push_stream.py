...
def heat(headers, domain):
    ...
    return res.status_code, res.json()["data"]["code"]
    ...
    if create_res.status_code == 200:
        ...
        if create_dict["status_code"] == 0:
            ...
            try:
                ...
                process = subprocess.Popen(ffmpeg_command, creationflags=subprocess.CREATE_NEW_PROCESS_GROUP)
                while True:
                    time.sleep(3)
                    heat(headers, domain)
